...
namespace Asiacell.ITADLibWCF.Business
{
    ...
    public class RequestObject
    {
        ...
        private Dictionary<string,string> _External_Data = new Dictionary<string,string>();
        /// <summary>
        /// 
        /// </summary>
        [DataMember]
        ...
        [DataMember]
        public Dictionary<string, string> External_Data { get { if (_External_Data == null) { _External_Data = new Dictionary<string, string>(); } return _External_Data; } }
