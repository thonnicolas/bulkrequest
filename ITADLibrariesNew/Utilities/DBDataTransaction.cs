...
namespace Asiacell.ITADLibraries_v1.Utilities
{
    ...
    public class DBDataTransaction
    {
        ...
        // constractor here
        public DBDataTransaction(String tableName, DBConnection db, int bulkBindCount, bool useBulkCopy, LoggerEntities logger)
        {
            this.logger = logger;
            // any code here
            this.db = db;
        ...
        private void WriteToServerBulkBinding(DataTable dataTable, OracleBulkCopyOptions options, IEnumerable<OracleBulkCopyColumnMapping> columnMappings)
        {
            ...
            using (var command = db.GetCommand())
            {
                ...
                try { 
                    ...
                    logger.AddtoLog(pid, "Failed to dispose command", LoggerLevel.Info);
                }
            }
        }
        /// <summary>
