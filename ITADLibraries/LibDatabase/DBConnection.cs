...
namespace Asiacell.ITADLibraries.LibDatabase
{
    public sealed class DBConnection : IDisposable
    {
        ...
        /// <summary>
        /// No encryption connection string
        /// </summary>
        /// <param name="ConnectionString"></param>
        /// <param name="logger"></param>
        public DBConnection(string ConnectionString, LoggerEntities logger)
        {
        ...
        /// <param name="ConnectionString"></param>
        /// <param name="logger"></param>
        public DBConnection(string ConnectionString, string key, LoggerEntities logger)
        {
            this.ConnectionString = (new Decryption(key,logger)).DecryptTripleDES(ConnectionString);
            IsDisposed = false;
            this.logger = logger;
        }
        ...
        public bool StartupConnectionWithoutFailover()
        {
            ...
            try
            {
                ...
                {
                    logger.AddtoLog("Failed to clear pools in reconnection", LoggerLevel.Info);
                }
        ...
        /// <summary>
        /// Update by vathna to clear all pending or open connection
        /// </summary>
