...
{     
    ...
    public class TransactionLogger<T> : ITaskExecutor, IDisposable where T : class
    {
        ...
        public TransactionLogger(string logFilePath, LoggerEntities logger, IAttributeValidator attributeValidator, long rotateSize = 10, string logFile = "translogs.log")
        {
            this.logger = logger;
            ...
            {
                AddAppender2(tranLogger, CreateFileAppender("TransactionLogFile", logFilePath + logFile));
            }
            else
            {
                AddAppender2(tranLogger, CreateFileAppender("TransactionLogFile", logFilePath + "\\" + logFile));
